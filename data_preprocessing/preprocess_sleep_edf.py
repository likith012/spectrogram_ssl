...
def main():
    ...
    parser.add_argument("--data_dir", type=str, default="/scratch/SLEEP_data/sleep-edf-database-expanded-1.0.0/sleep-cassette",
                        help="File path to the PSG and annotation files.")
    parser.add_argument("--output_dir", type=str, default="/scratch/SLEEP_data/sleepEDF20_multimod",
                        help="Directory where to save numpy files outputs.")
    parser.add_argument("--subjects_output_dir", type=str, default="/scratch/SLEEP_data/sleepEDF20_multimod_subjects",
                        help="Directory where to save numpy files outputs.")
    ...
    for i in range(len(psg_fnames)):
        ...
        raw_ch_df = raw.to_data_frame()[[select_ch,'EMG submental','EOG horizontal']]
